...
if __name__ == "__main__":
    ...
    with open("data/step4_adjcent_agglomeration_data/adjcent_agglomerations.csv" , "r" , encoding="utf-8") as input_file:
    ...
    #filename = "data/step5_global_agglomeration_data/global_agglomerations_beta.csv"
    #metadata.writeout(GlobalAggloIDFullLIST,filename)
    #with open("data/step5_global_agglomeration_data/global_agglomerations_beta.csv" , "w" , encoding="utf-8") as output_file:
    #    for each_row in GlobalAggloIDFullLIST:
    #        for each_field in each_row:
    #            output_file.write(str(each_field)+",")
    #        output_file.write("\n")
            
    print("Part5.1 is finished.") 
    ...
    filename = "data/step5_global_agglomeration_data/global_agglomerations_final.csv"
    metadata.writeout(outputLIST,filename)
    #with open("data/step5_global_agglomeration_data/global_agglomerations_final.csv" , "w" , encoding="utf-8") as output_file:
    #    for each_row in FinalGlobalAggloIDFullLIST:
    #        for each_field in each_row:
    #            output_file.write(str(each_field)+",")
    #        output_file.write("\n")

    print("#####################\nPart 5 program END. Global Agglomerations Fulllist is output.\n#####################")
