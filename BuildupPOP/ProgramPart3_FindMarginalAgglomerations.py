...
if __name__ == "__main__":
    ...
    filename = "data/step3_marginal_agglomeration_data/marginal_agglomerations.csv"
    metadata.writeout(MarginalAgglomerationsLIST,filename)
    
    #with open("data/step3_marginal_agglomeration_data/marginal_agglomerations.csv" , "w" , encoding="utf-8") as output_file:
