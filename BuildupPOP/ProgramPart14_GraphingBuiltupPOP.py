        ...
        for y in range(height):
            ...
            if temp[y,x] == 0:
                ...
                pix[x,y] = (int(round(255 - (255)/(1+6.96875*2.718281828**(-(0.0009*(temp[y,x])))))),
                            ...
                            int(round(256 - (255)/(1+7*2.718281828**(-(0.065*(temp[y,x])))))))
            # (R,G,B)
            #要用顏色深淺黎表達人口密度
            #人口密度上限係10000
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if query != int:
            ...
            for x in range(width):
                for y in range(height):
                    ...
                    if temp[y,x] == 0:
                        ...
                        pix[x,y] = (int(round(255 - (255)/(1+6.96875*2.718281828**(-(0.01933592691*(temp[y,x])))))),
                                    int(round(255 - (255)/(1+6.96875*2.718281828**(-(0.01933592691*(temp[y,x])))))),
                                    int(round(255 - (255)/(1+6.96875*2.718281828**(-(0.01933592691*(temp[y,x])))))))
                    # (R,G,B)
                    #要用顏色深淺黎表達人口密度
                    #人口密度上限係10000
            ...
            im.save("data/step14_graphing_builtuppop/map1/"+str(filename) + '.tif')
