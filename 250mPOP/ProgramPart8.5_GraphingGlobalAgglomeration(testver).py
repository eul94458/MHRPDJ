            ...
            for x in range(width):
                for y in range(height):
                    ...
                    if temp[y,x] == 0:
                        ...
                        pix[x,y] = (int(round(256 - (256)/(1+7*2.718281828**(-(0.03*(temp[y,x]/(10000/256))))))),
                                    int(round(256 - (256)/(1-14*2.718281828**(-(0.03*(temp[y,x]/(10000/256))))))),
                                    int(round(256 - (256)/(1-21*2.718281828**(-(0.03*(temp[y,x]/(10000/256))))))))
                    # (R,G,B)
                    #要用顏色深淺黎表達人口密度
                    #人口密度上限係10000
            ...
            for x in range(width):
                for y in range(height):
                    ...
                    if temp[y,x] == 0:
                        ...
                        pix[x,y] = (int(round(256 - (256)/(1+7*2.718281828**(-(0.05*(temp[y,x])))))),
                                    int(round(256 - (256)/(1+7*2.718281828**(-(0.04*(temp[y,x])))))),
                                    int(round(256 - (256)/(1+7*2.718281828**(-(0.03*(temp[y,x])))))))
                    # (R,G,B)
                    #要用顏色深淺黎表達人口密度
                    #人口密度上限係10000
                    #先將10000除256 得出256階linear色階
